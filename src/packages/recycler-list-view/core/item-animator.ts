...
export default interface ItemAnimator {
	...
	animateDidMount(atX: number, atY: number, itemReference: object, itemIndex: number): void;
	...
	animateWillUnmount(atX: number, atY: number, itemReference: object, itemIndex: number): void;
...
export class BaseItemAnimator implements ItemAnimator {
	...
	public animateDidMount(atX: number, atY: number, itemReference: object, itemIndex: number): void {
		//no need
	}
	...
	public animateWillUnmount(atX: number, atY: number, itemReference: object, itemIndex: number): void {
		//no need
	}
}
